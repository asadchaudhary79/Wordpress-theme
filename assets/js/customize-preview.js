...
( function( $ ) {
	...
	// Site Title checkbox.
	wp.customize( 'drowan_theme_options[site_title]', function( value ) {
	...
	wp.customize( 'drowan_theme_options[site_description]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	// Theme Layout.
	wp.customize( 'drowan_theme_options[theme_layout]', function( value ) {
		value.bind( function( newval ) {
			if ( 'boxed' === newval ) {
	...
	// Sidebar Position.
	wp.customize( 'drowan_theme_options[sidebar_position]', function( value ) {
		value.bind( function( newval ) {
	...
	wp.customize( 'drowan_theme_options[blog_title]', function( value ) {
		value.bind( function( to ) {
	...
	wp.customize( 'drowan_theme_options[blog_description]', function( value ) {
		value.bind( function( to ) {
	...
	// Read More textfield.
	wp.customize( 'drowan_theme_options[read_more_text]', function( value ) {
		value.bind( function( to ) {
			$( 'a.more-link' ).text( to );
		} );
	} );
	...
	// Blog Layout.
	wp.customize( 'drowan_theme_options[blog_layout]', function( value ) {
		value.bind( function( newval ) {
			if ( 'list' === newval ) {
	...
	// Post Date checkbox.
	wp.customize( 'drowan_theme_options[meta_date]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'drowan_theme_options[meta_author]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'drowan_theme_options[meta_category]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	// Post Tags checkbox.
	wp.customize( 'drowan_theme_options[meta_tags]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'drowan_theme_options[post_navigation]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'drowan_theme_options[post_image_archives]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'drowan_theme_options[post_image_single]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'drowan_theme_options[credit_link]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
